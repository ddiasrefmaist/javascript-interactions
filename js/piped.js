...
//FIM DO LIGHTBOX
    ...
    // $(".wrapperslider div").each(function(e) {
    //     if (e != 0)
    //         $(this).hide();
    // });
...
var slditem = $('.wrapperslider div');



slditem.on('click', function(){
 activeItem();
});


function activeItem() {
     $('.wrapperslider div').addClass('active');
}

    // $('.thumbs').append('<div class="thumbnails"><ul class="thumbnail_ul"></ul></div>');
