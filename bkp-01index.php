...
<script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        $('.bxsliderc2-mobile').bxSlider({
          autoControls: true,
                    TouchEnabled: true,

        });
         $('.bxsliderc3-mobile').bxSlider({

          autoControls: true,
                    TouchEnabled: true,
        });
        $('.bxsliderc4-mobile').bxSlider({
          autoControls: true,
                    TouchEnabled: true,
        });
        $('.bxsliderc5-mobile').bxSlider({

          autoControls: true,
                    TouchEnabled: true,
        });
        $('.bxsliderc6-mobile').bxSlider({
