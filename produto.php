    ...
    <li>
        ...
        <div class="productwrapper">
          ...
          <div class="productdesc">
            ...
            <div class="boxfit">
              <div class="saibamais"><a onclick="ga('send', 'event', 'clicou', 'visitarded');" href="descricao/produto/<?php echo $nomeLink; ?>">SAIBA MAIS</a></div>
            ...
            <div class="boxfit2"><div class="disponivel alegreya" >Disponível na <?php echo $loja; ?></div></div>
          </div>
        </div>
</li>
            <?php
