      ...
      <div class="container">
        <div class="row">
          <div class="boxTexto">
            ...
            <img src="<?php echo PATH_LOCAL; ?>images/<?php if($nomeh == "ASTI-MARMORES"){echo "ASTI-MARMORE";}else{ echo $nomeh; } ?>/logo.jpg" id="logoSpicy" alt="<?PHP echo str_replace('-', ' ', $explode[$n -1]); ?>" title="<?PHP echo str_replace('-', ' ', $explode[$n -1]); ?>">
          </div>
...
https://www.google.com.br/maps/place/Shopping+D%26D/@-23.609027,-46.6970214,19.41z/data=!4m15!1m9!4m8!1m0!1m6!1m2!1s0x94ce5732d799a8e1:0x2340ba4e12ce4b1a!2sShopping+D%26D+-+Av.+Na%C3%A7%C3%B5es+Unidas,+12555+-+Itaim+Bibi,+S%C3%A3o+Paulo+-+SP,+04578-000!2m2!1d-46.6969585!2d-23.6090249!3m4!1s0x94ce5732d799a8e1:0x2340ba4e12ce4b1a!8m2!3d-23.6090249!4d-46.6969585?hl=pt-BR">vem pro d&d</a>
    ...
    <!-- Links Lojas -->
        ...
        <div class="boxProdutos">
          <div class="imgProdutos"><img src="<?php echo PATH_LOCAL; ?><?php echo $img; ?>" class="imgProdutos" alt="<?php echo $nome; ?>" title="<?php echo $loja.' | '.$nome; ?>"></div>
          <div class="produto">
          ...
          <div class="btSaibaMaias">
            <a onclick="ga('send', 'event', 'clicou', 'visitarded');" href="<?php echo PATH_LOCAL; ?>descricao/descricao/produto/<?php echo $nomeLink; ?>" class="bottonSaibamais" title="Saber mais sobre <?php echo $nome; ?>">
              Saiba mais
            </a>
          </div>
